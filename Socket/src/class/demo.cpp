...
// void replaceInWstring(std::wstring& wstr, const std::wstring& from, const std::wstring& to) {
//     size_t start_pos = 0;

//     while((start_pos = wstr.find(from, start_pos)) != std::wstring::npos) {
...
//     {
//         std::wcout << ptr->at(i) << std::endl;
//     }
//     std::wstring str = ptr->at(ptr->size()-1).Icon;
//     replaceInWstring(str, L",0", L"");
