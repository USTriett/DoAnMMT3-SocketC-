...
vector<Software>* AppLister::GetAppLister(bool IncludeUpdates)
{
	return GetAppListerImp(IncludeUpdates);
}

vector<Software>* AppLister::GetAppListerImp(bool IncludeUpdates)
{
...
vector<Software>* AppLister::GetUserInstallerKeyPrograms(RegistryKey* uInstallerKey, vector<Software>* ExistingProgramList)
{
...
vector<Software>* AppLister::GetUninstallKeyPrograms(RegistryKey* UninstallKey, RegistryKey* ClassesKey, vector<Software>* ExistingProgramList, bool IncludeUpdates)
{
...
Software::Software(wstring, wstring, wstring, wstring, Arch, wstring appPath)
{
}
